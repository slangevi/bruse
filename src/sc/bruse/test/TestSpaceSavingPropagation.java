...
public class TestSpaceSavingPropagation {
	...
	public void testSoftEvidence() {
		try {
			...
			IPropagationEngine engine = PropagationEngineFactory.create(PropagationEngineFactory.PropagationType.SpaceSaving);
	...
	public void testHardEvidence2() {
		try {
			BruseNetwork network = BruseNetworkFactory.create("tests/test2.net");
			...
			assertTrue(isEqual(node.getStateValues()[node.getStateId("false")], 0.6200000000));
			assertTrue(isEqual(node.getStateValues()[node.getStateId("true")], 0.3800000000));
			...
			assertTrue(isEqual(node.getStateValues()[node.getStateId("false")], 0.3500000000));
			assertTrue(isEqual(node.getStateValues()[node.getStateId("true")], 0.6500000000));
